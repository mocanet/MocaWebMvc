...
<Assembly: WebActivator.PreApplicationStartMethod(GetType(Moca.Di.MocaContainerFactory), "Init", Order:=1)> 
<Assembly: WebActivator.PreApplicationStartMethod(GetType(Moca.Web.Mvc.MocaControllerFactory), "Init", Order:=2)> 
